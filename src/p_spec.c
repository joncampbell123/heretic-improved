...
sector_t *getNextSector(line_t *line,sector_t *sec)
{
  if (!(line->flags & ML_TWOSIDED))
	...
	/* // VR: old code removed, added BOOM - crash in E3M8 still not fixed
 ...
 *
 * VR: This clever Lee's rewrite also fixed bug in Heretic E3M8
 */
  ...
  switch(line->special)
    {
       ...
       */
    case 2: /* Open Door */
      EV_DoDoor(line,dopen,VDOORSPEED);
      line->special = 0;
      break;
    case 3: /* Close Door */
      EV_DoDoor(line,dclose,VDOORSPEED);
      line->special = 0;
      break;
    case 4: /* Raise Door */
...
void P_AmbientSound(void)
{
  ...
  do
	...
	case afxcmd_play:
	  ...
	  S_StartSoundAtVolume(NULL, *AmbSfxPtr++, AmbSfxVolume >> 3);
	  break;
	case afxcmd_playabsvol:
	  sound = *AmbSfxPtr++;
	  AmbSfxVolume = *AmbSfxPtr++;
	  S_StartSoundAtVolume(NULL, sound, AmbSfxVolume >> 3);
	  break;
